/* Modified to fit into application. Based on open source Android example.
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                // If you want to switch to back facing camera, replace LENS_FACING_FRONT
                // with LENS_FACING_BACK
